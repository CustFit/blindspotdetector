    ...
    <main>
        <section class="hero">
            <div class="container">
                ...
                <a href="#detector" class="btn-primary">Start Assessment</a>
                <a href="Customer_Blind_Spot_Detector.pdf" class="btn-secondary" download>Download PDF Version</a>
            </div>
        </section>
            ...
            <div class="container">
                <form id="blindSpotForm">
                    ...
                    <div class="submit-container">
                        <button type="submit" class="btn-primary">Calculate My Results</button>
                    </div>
                </form>
